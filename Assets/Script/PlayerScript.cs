...
public class PlayerScript : MonoBehaviour {  
    ...
    void Update () {
        ...
        if (Input.GetButton("Vertical") && Input.GetButton("Horizontal")) WakeDiag();
        else if (Input.GetButton("Vertical")) WakeUp(1.0F);
        else if (Input.GetButton("Horizontal")) Wake(1.0F);
        else
        {
